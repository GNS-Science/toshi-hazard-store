...
The class is tested against fixtures generated by OQ 3.19.1–3.25.1. It is also tested againt the 3.25.1 `openquake.calculators.extract.Extractor` for strucutre and numerical equivalence. 
