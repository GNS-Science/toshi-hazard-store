# flake8: noqa
"""Console script for exporting an openquake hazard realistations to a parquet partition.
...
def rlz(calc_id, compatible_calc_fk, producer_config_fk, hazard_calc_id, verbose, dry_run):
