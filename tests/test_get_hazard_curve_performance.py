...
# locations = [CodedLocation(location_by_id(loc_id)['latitude'], location_by_id(loc_id)['longitude'], 0.001).code for loc_id in id_list]
...
def test_curves_equiv():
    ...
    def build_dataframe():
        ...
        locations, vs30_list, imts, aggs = short_lists()
        locations = [CodedLocation(location_by_id(loc_id)['latitude'], location_by_id(loc_id)['longitude'], 0.001) for loc_id in id_list]
